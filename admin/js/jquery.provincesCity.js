...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select name='province' class='text' id='province'></select>");
	_self.append("<select name='city' class='text' id='city'></select>");
	_self.append("<select name='township' class='text' id='township'></select>");
	//分别获取3个下拉框
