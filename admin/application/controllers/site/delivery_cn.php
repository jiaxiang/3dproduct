...
class Delivery_cn_Controller extends Template_Controller{
     ...
     */
    function add(){    
        $this->template->content = new View("site/delivery_cn_add", array('unit_list' => Kohana::config('delivery.unit') ));
    }
    ...
    { 
        ...
        $this->template->content = new View("site/delivery_cn_edit");
    ...
    function sel_country()
    {
        ...
        $this->template->content = new View("site/delivery_cn_country_list");
