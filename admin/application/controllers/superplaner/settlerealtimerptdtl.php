...
//        $dataList = Superplaner_settlerealtimerptdtl::instance()->lists($query_struct);
        $dataList = Superplaner_settlerealtimerptdtl::instance()->mylists($query_struct);
		...
		$this->template->content = new View("superplaner/settle_realtime_dtl_rpt");
