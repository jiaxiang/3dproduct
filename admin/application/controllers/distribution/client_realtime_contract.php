<?php
class Client_realtime_contract_Controller extends Template_Controller 
{
	...
	public function index() 
	{
		...
		$this->template->content = new View("distribution/client_realtime_contract_list");
	...
	public function add($relationId)
	{
		...
		if($_POST) 
		{
			...
			{
				remind::set(Kohana::lang('o_global.add_success'),'distribution/client_realtime_contract/index?relationId='.$relationId,'success');
			}
			else
			{
		...
		$this->template->content = new View("distribution/client_realtime_contract_add");
	...
	public function edit($contractId)
	{
		...
		$this->template->content = new View("distribution/client_realtime_contract_edit");
	...
	public function delete($contractId)
	{
		...
		{
			remind::set(Kohana::lang('o_global.delete_success'),'distribution/client_realtime_contract/index?relationId='.$contract['relation_id'],'success');
		}
		else 
		{
			remind::set(Kohana::lang('o_global.delete_error'),'distribution/client_realtime_contract/index?realtionId='.$contract['relation_id'],'error');
		}
