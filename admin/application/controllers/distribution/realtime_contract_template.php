...
class Realtime_contract_template_Controller extends Template_Controller 
{
	...
	public function index() 
	{
		...
		$this->template->content = new View("distribution/realtime_contract_template_list");
	...
	public function add()
	{
		...
		if($_POST) 
		{
			...
			{
				remind::set(Kohana::lang('o_global.add_success'),'distribution/realtime_contract_template/','success');
			}
			else
			{
		...
		$this->template->content = new View("distribution/realtime_contract_template_add");
	}
	...
	public function delete($templateId)
	{
		...
		if(MyRealtime_contract_template::instance($templateId)->delete())
		{
