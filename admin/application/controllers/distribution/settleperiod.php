<?php
class Settleperiod_Controller extends Template_Controller 
{
	...
	{
		$settlemonthrptDao = Mysettleperiod::instance();
        ...
        $dataList = Mysettleperiod::instance()->lists($query_struct);
		...
		$this->template->content = new View("distribution/settle_period");
