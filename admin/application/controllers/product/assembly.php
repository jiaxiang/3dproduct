...
class Assembly_Controller extends Template_Controller {
    ...
    public function validate_spec()
    {
       ...
       try {
            ...
            if (empty($request_data['assembly_id']) 
            ...
            $assembly_id = (int)$request_data['assembly_id'];
            $attribute_spec = $request_data['attribute_spec'];
            
            if(BLL_Product_Type_Assembly::attribute_spec_exists($assembly_id, $attribute_spec, $product_id))
            {
            	throw new MyRuntimeException(Kohana::lang('o_product.spec_has_exists'), 500);
            }
