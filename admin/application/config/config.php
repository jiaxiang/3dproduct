...
/*
 * protocol of the front web site.
 * zhu
 */
$config['front_protocol'] = 'http://';
 ...
 */
$config['internal_cache_path'] = PROJECT_ROOT.'var/cache/web/app/config/';
 ...
 */
$config['log_directory'] = PROJECT_ROOT.'var/log';
...
(
	...
	MODPATH.'crond',        // task modules
	// MODPATH.'unit_test', // Unit testing
	MODPATH.'kc', // Unit testing
	MODPATH.'stat', // add by gehaifeng
);

/**
 * 新增加的对象加载机制在加载对象时所需要检索的目录
 * 
 * @var array
 */
