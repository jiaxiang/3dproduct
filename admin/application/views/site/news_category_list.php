    ...
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                ...
                <li class="on"><a href='<?php echo url::base() . 'site/news_category/';?>'>新闻分类列表</a></li>
            </ul> 
        </div>
        <div class="newgrid_top">
            <ul class="pro_oper">
				 <li><span  class="add_pro"><a href='<?php echo url::base() . 'site/news/';?>'>返回新闻列表</a></span></li>
            	<?php echo role::view_check('<li><span class="add_pro"><a href="/site/news_category/add">添加新闻分类</a></span></li>', 'action_edit');?>          
            </ul>
        </div>
        ...
        <table  cellspacing="0">
                ...
                <tbody id="list-line">
                    ...
                    <tr id="<?php echo $value['level_depth'];?>" name="<?php echo $value['id'];?>" class="row">
                        ...
                        <td><?php echo role::view_check('<a href="' . url::base() . 'site/news_category/edit?id=' . $value['id'] . '" >编辑</a>', 'action_edit');?>
                        </td>
                        <?php
...
<script type="text/javascript">
    ...
    $('input[name=submit_order_form]').click(function(){
        var url = '<?php echo url::base();?>site/news_category/set_order';
        var obj = $(this).parent();
