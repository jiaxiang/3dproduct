...
<!-- header_content(end) -->
<!--** content start**-->
<form id="add_form" name="add_form" method="post" action="<?php echo url::base();?>site/delivery_cn/do_add">
  <div class="out_box"> 
    ...
    <div class="new_order_con fixfloat "> 
      ...
      <table cellspacing="0" class="table_overflow">
        ...
        <col />
          <tr>
            <td class="a_right a_title"><span class="required">* </span>配送方式名称：</td>
            <td><input type="text" name="name" class="text input_300px required" maxlength="100"/></td>
          </tr>
          <tr>
            <td class="a_right a_title">物流公司网址：</td>
            <td><input type="text" name="url" class="text input_300px url" maxlength="200"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td id="country_control"><input type="radio" name="type" value="0" checked /> 统一设置         &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="1"/> 指定配送地区和费用 </td>
          </tr>      
      </table>
    </div>
    ...
    <div id="delivery_default" class="new_order_con fixfloat " style="display:;" >
      <table cellspacing="0" class="table_overflow">
        ...
        <col />
         <tr>
            <td class="a_right a_title_last"><span class="required">* </span>配送费用：</td>
            <td>
    ...
    <div id="set_country_price" class="new_order_con fixfloat " style="display:none">
      ...
      <col width="150">
        <col />
         <tr>
            <td class="a_right a_title_last v_top"><span class="required"> * </span>支持的配送地区：</td>
            <td>
                <div>
    ...
    <div class="new_order_con fixfloat ">
      ...
      <col width="150">
        <col />
         ...
         <tr>
            <td class="a_right a_title"><span class="required">* </span>排序：</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('input[name^="country_names_"], .sel_country').live('click keyup', function(){
            ...
            if($.count(country_ids) > 0 && $.count(selected_country_ids[country_area_id]) <= 0){
                var url = url_base + 'site/delivery_cn/sel_country?country_ids='+country_ids;
            }else{
                var url = url_base + 'site/delivery_cn/sel_country';
            }
    ...
    function renderSelCountrys(id){        
        ...
        if(typeof selected_country_ids[id] != 'defined' && $.count(selected_country_ids[id]) > 0){
            ...
            $.ajax({
                url: url_base + 'site/delivery_cn/get_country?country_ids=' + country_ids,
                type: 'GET',
                dataType: 'json',
