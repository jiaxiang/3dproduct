...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href='<?php echo url::base() . 'site/delivery/';?>'>物流列表</a></li>
            </ul>
        </div>
        <div class="newgrid_top">
            <ul class="pro_oper">
                <?php echo role::view_check('<li><a href="'.url::base().'site/delivery/add" ><span class="add_pro">添加物流</span></a></li>', 'site_carrier_add');?>
        ...
        <table class="table_overflow" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?php echo url::base();?>site/delivery/edit/<?php echo $rs['id'];?>">编辑</a>
                     <?php echo role::view_check('<a href="'.url::base().'site/delivery/do_delete/'.$rs['id'].'" onclick="javascript:return confirm(\'确定删除？\')" >删除</a>', 'site_carrier_delete');?>
                    </td>
                    <td><?php echo $rs['name']?></td>
                    <td><?php if($rs['type'] == 1) : ?>指定配送国家和费用
                        <a href="<?php echo url::base();?>site/delivery_country/index/<?php echo $rs['id'];?>"> 查看</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('input[name=submit_order_form]').click(function(){
            var url = '<?php echo url::base();?>site/delivery/set_order';
            var obj = $(this).parent();
        ...
        $("#batch_delete").click(function(){
            ...
            $('#list_form').attr('action','/site/delivery/batch_delete/');
            $('#list_form').submit();
            return false;
        });
