    ...
    <div class="grid_c2">
        <div class="col_main">
            ...
            <form id="add_form" name="add_form" method="post" action="<?php echo url::base() . url::current();?>">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    <th width="15%">站点： </th>
                                    <td>
                                        <select tabindex="3" name="site_id">
                                            <?php foreach ($site_list as $key=>$value) {?>
                                            <option value="<?php echo $key;?>"  <?php if ($key == $data['site_id'])echo "SELECTED";?>><?php echo $value;?></option>
                                                <?php }?>
                                        </select>
                                    </td>
                                    <td> &nbsp;</td>
                                ...
                                <tr>
                                    <th>名称：</th>
                                    <td><input size="60" name="name" class="text required" value="<?php echo $data['name'];?>"><span class="required"> *</span>
                                    </td>
                                    <td> &nbsp;</td>
                                </tr>
                                <tr>
                                    <th>链接：</th>
                                    <td><input size="60" name="url" class="text required" value="<?php echo $data['url'];?>"><span class="required"> *</span> </td>
                                    <td> 前台显示指向该物流方式的链接,例如  http://www.ems.com.cn/english-main.jsp </td>
                                </tr>
                                <tr>
                                    <th>物流说明：</th>
                                    <td><input size="60" name="delay" class="text required" value="<?php echo $data['delay'];?>"><span class="required"> *</span></td>
                                    <td> 前台显示的物流方式简单说明,如:3-5 days </td>
                                </tr>
                                <tr>
                                    <th>计算方法：</th>
                                    <td>
                                        <input type="radio" name="type" value="0" <?php if ($data['type'] == 0)echo "checked";?>>
                                        统一定价
                                    ...
                                    <td> 基于价格衡量,则前台将以订单总金额在何金额区间来决定实际的物流费用,请于列表页添加衡量区间</td>
                                </tr>
                                <tr id="price" <?php if($data['type'] == 1) {?>style="display:none;"<?php } ?>>
                                    <th>统一定价运费金额：</th>
                                    <td><input size="30" name="price" class="text" value="<?php echo $data['price'];?>"><span class="required"> *</span> 单位：美元 USD</td>
                                    <td> &nbsp;</td>
                                </tr>
                                <tr>
                                    <th>地区费用类型：</th>
                                    <td>
                                        <input type="radio" name="country_relative" value="0" <?php if ($data['country_relative'] == 0)echo "checked";?>>
                                        统一设置
                                        <input type="radio" name="country_relative" value="1" <?php if ($data['country_relative'] == 1)echo "checked";?>>
                                        指定配送国家和费用
                                    </td>
                ...
                <div class="list_save">
                    <span id="single" style="display:<?php echo (($data['type'] > 0) or ($data['country_relative'] > 0 ))?'none':'';?>">
                    ...
                    <span id="next_step" style="display:<?php echo ($data['type'] > 0)?'':'none';?>">
                        <input type="button" name="button" class="ui-button" value="下一步"  onclick="submit_form(2);"/>
                    </span>
                    <span id="next_step_country" style="display:<?php echo (($data['type'] == 0) && ($data['country_relative'] > 0 ))?'':'none';?>">
