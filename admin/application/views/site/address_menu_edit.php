                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <th>URL：</th>
                                    <td>
                                        <input type="text" size="40" id="url" name="url" class="text required" value="<?php echo $site_menu_data['url'];?>"/><span class="required"> *</span>
                                        <span class="notice_inline">
                                            不需要填写域名，填写站内路径(例：首页为'/')，根据实际链接设定。
                                        </span>
                                    </td>
                                </tr>
