...
<!-- header_content(end) -->
<!--** content start**-->
<form id="add_form" name="add_form" method="post" action="<?php echo url::base();?>site/deliverycn/do_add">
  <div class="out_box"> 
      ...
      <table cellspacing="0" class="table_overflow">
        ...
        <col />
          ...
          <tr>
            ...
            <td id="region_control"><input type="radio" name="type" value="0" checked /> 统一设置         &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="type" value="1"/> 指定配送国家和费用 </td>
          </tr>      
      </table>
    </div>
    ...
    <div id="set_region_price" class="new_order_con fixfloat " style="display:none">
      <table cellspacing="0" class="table_overflow">
      <col width="150">
        <col />
         <tr>
  ...
  <div id="region_sel_ifm" class="ui-dialog-content ui-widget-content" style="height:270px;min-height:100px;width:auto;display:none;">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
	    ...
	    jQuery.extend({
	       ...
	       //国家费用类型选择
		$('#region_control').bind('click', function(e){
			var o = $(e.target);
	    ...
	    var region_sections = function(){
			...
			var t = {
				...
				add: function(sec) {
					...
					row_city.append('<span class="small_btn right"><span class="del"></span></span>配送地区 <input type="text" id="region_names_' + idx + '" name="region_names_' + idx + '" class="input_300px text required" readonly="true" style="background-color:#f1f1f1" value=""/>');
					row_city.append('<span id="sel_region_' + idx + '" class="sel_region"><img src="'+url_base+'images/icon_view.gif"></span>');
					row_city.append('<input type="hidden" name="region_ids_' + idx + '" id="region_ids_' + idx + '" value="" style="width:10px;"><input type="hidden" name="des_indexs[]" value="' + idx + '" style="width:10px;">');
					...
					row_exp.append('<input type="hidden" name="regions_use_exp_' + idx + '" value="0"></input> <span class="delivery_msg" value="1" onclick="javascript:changeExp(this);"><a>取消公式</a></span>');
        ...
        $('input[name^="region_names_"], .sel_region').live('click keyup', function(){
            ...
            if($.count(region_ids) > 0 && $.count(selected_region_ids[region_area_id]) <= 0){
    ...
    function renderSelRegions(id){        
    	...
    	if(typeof selected_region_ids[id] != 'defined' && $.count(selected_region_ids[id]) > 0){
    		...
    		$("#region_ids_"+id).attr('value', region_ids);
