                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    <th width="15%">分类名称：</th>
                                    <td>
                                        <input type="type" size="50" name="category_name" maxlength="250" class="text required" value="<?php echo $data['category_name'];?>" /><span class="required"> *</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>上级分类：</th>
                                ...
                                <tr>
                                    <th>排序：</th>
                                    <td>
                                        <input type="type" size="5" name="title" class="text required number" value="<?php echo $data['p_order'];?>" maxlength="5"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
