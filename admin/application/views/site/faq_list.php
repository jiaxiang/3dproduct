...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href='<?php echo url::base() . 'site/faq/';?>'>站点FAQ列表</a></li>
            </ul>
        </div>
        <div class="newgrid_top">
            <ul class="pro_oper">
                <li>
                    <a href="/site/faq/add"><span class="add_pro">添加FAQ</span></a>
                </li>
        ...
        <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input class="sel" name="faq_ids[]" value="<?php echo $item['id'];?>" type="checkbox" /></td>
                        <td><a href="/site/faq/edit/<?php echo $item['id']; ?>">编辑</a>&nbsp;
                            <a href="/site/faq/delete/<?php echo $item['id']; ?>" onclick="javascript:return confirm('确定删除？')"> 删除</a>
                        </td>
...
<script type="text/javascript">
        ...
        $('input[name=submit_order_form]').click(function(){
            var url = '<?php echo url::base();?>site/faq/set_order';
            var obj = $(this).parent();
        ...
        $("#batch_delete").click(function(){
            ...
            if(!confirm('确认删除选中的faq？')){
                return false;
            }
            $('#list_form').attr('action','/site/faq/batch_delete/');
            $('#list_form').submit();
            return false;
        });
    });
