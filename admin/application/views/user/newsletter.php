...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href='<?php echo url::base() . 'user/newsletter/';?>'>Newsletter列表</a></li>
            </ul>
            <span class="fright">
                <?php if(site::id()>0):?>
        ...
        <?php if (is_array($newsletter_list) && count($newsletter_list)) {?>
        <table  cellspacing="0">
            <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                <thead>
                    <tr class="headings">
                            ...
                            <?php echo view_tool::sort('注册时间',6, 150);?>
                            <?php echo view_tool::sort('IP/地址', 8, 100);?>
                            <?php echo view_tool::sort('状态', 10, 30);?>
                    </tr>
                </thead>
                <tbody>
                        <?php foreach ($newsletter_list as $rs) : ?>
                    <tr>
