...
<div id="content_frame">
    <div class="grid_c2">
        <div class="col_main">
            <!--**edit start**-->
            <form id="add_form" name="add_form" method="post" action="<?php echo url::base().'user/user_attribute/put';?>" >
                <div class="edit_area">
                    <div class="division">
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tbody>
                                <tr>
                                  <th>注册项名称：</th>
                                  <td><input type="text" name="attribute_name" id="attribute_name" class="required text" /><span style="color:#F00;">*</span></td>
                                </tr>
                                <tr>
                                  <th>是否必填：</th>
                                  <td><input type="checkbox" name="attribute_required" id="attribute_required" value="1" class="sel"/></td>
                                </tr>
                                <tr>
                                  <th>类型：</th>
                                  <td>
                                    <select name="attribute_type" id="attribute_type" class="text">
                                      ...
                                      <optgroup label="<?php isset($attribute_type_group[$key]) && print($attribute_type_group[$key]);?>">
                                       ...
                                       <option value="<?php echo $key.'.'.$key1;?>"> <?php echo $value['name'];?> </option>
                                       <?php endforeach;?>
                                       </optgroup>
                                      <?php endforeach;?>
                                    </select>
                                ...
                                <tr style="display:none;">
                                  <th>选项内容：</th>
                                  <td><input type="text" name="attribute_option[]" class="text"/> <span name="del_option" style="color:#F00;">X</span></td>
                                </tr>
                                <tr style="display:none;">
                                  <th> </th>
                                  <td >
