...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href='<?php echo url::base() . 'user/user/';?>'>会员列表</a></li>
            </ul>
        </div>
        <div class="newgrid_top">
            <ul class="pro_oper">
                <!-- li><a href="javascript:void(0);"><span class="del_pro" id="batch_delete">批量停用</span></a></li>
                <li><a href="javascript:void(0);"><span class="rec_pro" id="batch_recover">批量恢复</span></a></li>
            ...
            <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                <thead>
                    <tr class="headings">
                        ...
                        <th width="150px">操作</th>
                        	<?php echo view_tool::sort('ID',0, 100);?>
                            <?php echo view_tool::sort('Email',6, 200);?>
                            <?php echo view_tool::sort('用户名',4, 100);?>
                            <?php echo view_tool::sort('真实姓名',10, 100);?>
                            <?php echo view_tool::sort('注册时间', 12, 100);?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        	<a href="<?php echo url::base();?>user/user/detail/<?php echo $rs['id'];?>">查看</a>&nbsp;
                            <a href="<?php echo url::base();?>user/user/edit/<?php echo $rs['id'];?>">编辑</a>&nbsp;
                            <!--  a href="<?php echo url::base();?>user/user/recharge/<?php echo $rs['id'];?>">充值</a>
                            <br />
                        	<a href="<?php echo url::base();?>user/user/account/<?php echo $rs['id'];?>">资金动态</a>&nbsp;
                            <a href="<?php echo url::base();?>user/user/user_money/<?php echo $rs['id'];?>">资金明细</a>&nbsp;-->
                        </td>
                        <td><?php echo $rs['id'];?>&nbsp;</td>
                        <td><?php echo $rs['email'];?>&nbsp;</td>
                        <td><?php echo $rs['username'];?>&nbsp;</td>
                        <td><?php echo $rs['name'];?>&nbsp;</td>
                        <td><?php echo $rs['reg_time'];?>&nbsp;</td>
                        <td><?php echo User_Model::show_status($rs['status']);?>&nbsp;</td>
