...
<div class="new_sub_menu">
    <div class="new_sub_menu_con">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href="/user/user/recharge/<?php echo $data['id'];?>">用户充值</a></li>
                <li><a href="/user/user/recharge_virtual_money/<?php echo $data['id'];?>">竞波币充值</a></li>
            </ul>
        </div>
    </div>
</div>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                    	...
                                    	foreach ($money_type_set as $key => $val) {
