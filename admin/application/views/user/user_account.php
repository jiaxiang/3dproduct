...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href="/user/user/account/<?php echo $userid;?>">资金变动明细</a></li>
                <li><a href="/user/user/virtual_money_account/<?php echo $userid;?>">竞波币变动明细</a></li>
            </ul>
        </div>
        ...
        <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/user/user/user_money/<?php echo $row['user_id'];?>/<?php echo $row['id'];?>">详细记录>></a>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        现在余额:<?php echo ($data['user']['user_money']+$data['user']['bonus_money']+$data['user']['free_money']);?>元
                        [本金:<?php echo $data['user']['user_money'];?>+奖金:<?php echo $data['user']['bonus_money'];?>+彩金:<?php echo $data['user']['free_money'];?>]
                        &nbsp;&nbsp;&nbsp;(注意:此处为该会员总的统计数据)
                        </td>
                    </tr>                     
