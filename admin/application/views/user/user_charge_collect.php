...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href='<?php echo url::base() . 'user/user_charge_collect/';?>'>会员资金汇总</a></li>
                <li><a href='<?php echo url::base() . 'user/user_charge_collect/virtual';?>'>会员竞波币汇总</a></li>
            </ul>
        </div>
        <?php 
            ...
            <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                <thead>
                    ...
                    <?php  if(!isset($_GET['order'])) {
                           ...
                           <th width="50px"><a href="<?php echo url::base().url::current();?>?order=Betting_count`<?php if($order=="Betting_count`DESC"){echo 'ASC';}else{echo 'DESC';}?>&search_value=<?php echo $date?>&page=<?php echo $page?>&per_page=<?php echo $per_page?>">发单数</th>                 
                           <th width="50px"><a href="<?php echo url::base().url::current();?>?order=win_count`<?php if($order=="win_count`DESC"){echo 'ASC';}else{echo 'DESC';}?>&search_value=<?php echo $date?>&page=<?php echo $page?>&per_page=<?php echo $per_page?>">中奖数</th>
                           <th width="50px"><a href="<?php echo url::base().url::current();?>?order=win_num`<?php if($order=="win_num`DESC"){echo 'ASC';}else{echo 'DESC';}?>&search_value=<?php echo $date?>&page=<?php echo $page?>&per_page=<?php echo $per_page?>">奖金</th>
                           <th width="150px"><a href="<?php echo url::base().url::current();?>?order=user_charge`<?php if($order=="user_charge`DESC"){echo 'ASC';}else{echo 'DESC';}?>&search_value=<?php echo $date?>&page=<?php echo $page?>&per_page=<?php echo $per_page?>">充值金额</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $rs['Betting_count']?>&nbsp;</td>
                        <td><?php echo $rs['win_count'];?>&nbsp;</td>                       
                        <td><?php echo $rs['win_num'];?>&nbsp;</td>
                        <td><?php echo $rs['user_charge'];?>&nbsp;</td>
                    </tr>
                        <?php endforeach;?>
                </tbody>
            </form>
