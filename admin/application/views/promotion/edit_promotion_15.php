            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tbody>            
                ...
                <tr>
                  ...
                  <td><input type="text" style="" size="10" name="quantity_from" value="<?php (isset($quantity_from) && print($quantity_from))|| print($promotion['quantity_from'])?>" class="text t40 _x_ipt required" />≤购买数量＜<input type="text" style="" size="10" name="quantity_to" class="text t40 _x_ipt required" value="<?php (isset($quantity_to) && print($quantity_to))|| print($promotion['quantity_to'])?>" /></td>
                </tr>
                <tr>
                  <th>开始时间：</th>
                ...
                <tr>
                  <th>规则标题<span style="color:#F00">*</span>：</th> <td><input type="text" style="" size="60" name="pmt_description" class="text required"  value="<?php (isset($pmt_description) && print($pmt_description))||print($promotion['pmt_description']);?>"/>(该标题会在购物车中显示)</td>
                </tr>
                <tr>
                  <th>规则描述：</th>
