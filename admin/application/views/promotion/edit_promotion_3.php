            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tbody>               
                ...
                <tr>
                  ...
                  <td><input type="text" style="" size="10" name="quantity_from" value="<?php (isset($quantity_from) && print($quantity_from))|| print($promotion['quantity_from'])?>" class="text required" />≤购买数量<<input type="text" style="" size="10" name="quantity_to" class="text required" value="<?php (isset($quantity_to) && print($quantity_to))|| print($promotion['quantity_to'])?>" /></td>
                </tr>
                <tr>
                  <th>开始时间：</th>
