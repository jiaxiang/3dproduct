            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tbody>               
                ...
                <tr>
                  ...
                  <td><input type="text" style="" size="10" name="money_from" class="text t40 _x_ipt required" value="<?php isset($money_from) && print($money_from);?>"/>≤订单金额＜<input type="text" style="" size="10" name="money_to" class="text t40 _x_ipt required" value="<?php (isset($money_to) && print($money_to)) || print("9999999");?>" />(金额的最大值为999999999999.999)</td>
                </tr>
                <tr>
                  <th>开始时间：</th>
                ...
                <tr>
                  <th>选择参加促销的商品<span style="color:#F00">*</span>：</th>
...
<?php echo $js_product_field;?>
    ...
    $('a[name=products_page]').live('click',function(){//modify
        ...
        var check = "checkAll";
        var thing = "products";
        var table = "productTable";alert(1);
        tranData(url ,type,keyword ,check,thing,product_field,table);
        return false;
    });
});
