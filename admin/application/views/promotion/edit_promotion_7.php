          ...
          <div class="out_box">
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tbody>
                ...
                <tr>
                  <th>选择指定商品<span style="color:#F00">*</span>：</th>
                  <td><?php echo $products_area;?></td>
                </tr>
                <tr>
                  <th width="20%">货品金额条件<span style="color:#F00">*</span>： </th>
                  <td><input type="text" style="" size="10" name="money_from" value="<?php (isset($money_from) && print($money_from))|| print($promotion['money_from'])?>" class="text t40 _x_ipt required" />≤货品金额＜<input type="text" style="" size="10" name="money_to" class="text t40 _x_ipt required" value="<?php (isset($money_to) && print($money_to))|| print($promotion['money_to'])?>" />(金额的最大值为999999999999.999)</td>
                </tr>
                <tr>
                  <th>选择赠品<span style="color:#F00">*</span>：</th>
...
<!--**content end**-->
<!-- dialog form start -->
<?php echo $dialog_product;?>
<!-- dialog form end -->
<!-- dialog form start -->
<?php echo $dialog_good;?>
<!-- dialog form end -->
...
<?php echo $js_good_field;?>
    ...
    $("#goodSearchbtn").click(function(){
        ...
        var thing = "goods";
        var table = "goodTable";
        tranData(url ,type,keyword ,site_id,check,thing,good_field,table);
    }).click();
