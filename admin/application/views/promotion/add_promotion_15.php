            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tbody>               
                ...
                <tr>
                  ...
                  <td><input type="text" style="" size="10" name="quantity_from" class="text t40 _x_ipt required" value="<?php isset($quantity_from) && print($quantity_from);?>"/>≤购买数量＜<input type="text" style="" size="10" name="quantity_to" class="text t40 _x_ipt required" value="<?php (isset($quantity_to) && print($quantity_to)) || print("9999999");?>" /></td>
                </tr>
                <tr>
                  <th>开始时间：</th>
