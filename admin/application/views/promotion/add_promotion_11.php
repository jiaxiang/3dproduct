            ...
            <table cellspacing="0" cellpadding="0" border="0" width="100%">
              <tbody>               
                ...
                <tr>
                  ...
                  <td><input type="text" style="" size="10" name="money_from" class="text t40 _x_ipt required" value="<?php isset($money_from) && print($money_from);?>"/>≤购物车金额＜<input type="text" style="" size="10" name="money_to" class="text t40 _x_ipt required" value="<?php (isset($money_to) && print($money_to)) || print("9999999");?>" />(金额的最大值为999999999999.999)</td>
                </tr>
                <tr>
                  <th>开始时间：</th>
