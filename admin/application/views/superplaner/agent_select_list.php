...
<div class="new_content">
	<div class="newgrid">
		<div class="newgrid_tab fixfloat">
			<ul>
				<li class="on"><a href='<?php echo url::base().'superplaner/agent_select/';?>'>添加超级发单人</a></li>
			</ul>
		</div>
		<div class="newgrid_top">
			<form id="search_form" name="search_form" class="new_search" method="GET" 
					action="<?php echo url::base() . 'superplaner/agent_select/';?>">
			<div>搜索：
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo url::base().'superplaner/agent/add/'.$rs['id'];?>">超级发单人</a>
						</td>
