<div class="new_content">
	<div class="newgrid">
		<div class="newgrid_tab fixfloat">
			<ul>
				<li class="on"><a href='<?php echo url::base().'distribution/realtime_contract_template/';?>'>实时合约模板列表</a></li>
			</ul>
		</div>																																												
		...
		<form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
			...
			<tbody>
				...
				<tr>
					<td>
						<a href="<?php echo url::base().'distribution/realtime_contract_template/delete/'.$item['id']; ?>" 
