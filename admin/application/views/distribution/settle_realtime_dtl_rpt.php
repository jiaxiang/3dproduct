		...
		<div class="newgrid_top">
            <form action="<?php echo url::base() . url::current();?>" method="GET" name="search_form" class="new_search" id="search_form">
                ...
                <div>搜索:
                	...
                	<span style="font-weight:bold">代理用户名</span>：<input class="text" type='text' name='agentlastname' value='<?php echo !empty($pre_get['agentlastname']) ? $pre_get['agentlastname'] : '';?>'/>
			...
			<tbody>
				...
				>
					...
					<td style='font-weight:bold'><?php 
						...
						else if ($item['flag']==0) echo '<span style="color:black;font-weight:bold">结束</span>';
