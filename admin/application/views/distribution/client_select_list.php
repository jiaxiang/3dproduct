...
<div class="new_content">
	<div class="newgrid">
		<div class="newgrid_tab fixfloat">
			<ul>
				<li class="on">
				<a href='<?php echo url::base().'distribution/client_select/index/'.$agent['user_id'];?>'>
					添加<?php echo $agent['lastname'];?>的下级用户</a>
				</li>
			</ul>
		</div>
		<div class="newgrid_top">
			<form id="search_form" name="search_form" class="new_search" method="GET" 
					action="<?php echo url::base().'distribution/client_select/index/'.$agent['user_id'];?>">
			<div>搜索：
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<?php if(isset($agent)) {?>
							<a href="<?php echo url::base().'distribution/agent_client/add/'.$agent['user_id'].'/'.$rs['id'];?>">添加为下级</a>
							<?php } else {?>
						...
						{
							//$mail_key = '';
							//$mail_key = Mytool::hash($rs['password'].$mail_check_pwd);
							//$mail_key = "http://www.jingbo365.com/user/reg_success/?key=".$mail_key."&id=".$rs['id']."&u=".$rs['lastname']."&e=".$rs['email'];
							//echo '<a href="'.$mail_key.'" target="_blank">[手动激活]</a>';
						}
						?>
                        ...
                        <?php /**?><td><?php echo $rs['level'];?></td><?php **/?>
