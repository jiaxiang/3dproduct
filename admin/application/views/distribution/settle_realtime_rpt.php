	...
	<div class="newgrid">
		...
		<form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
			<thead>
				...
				<th width="40px">操作</th>
				<th width="30px">代理</th>
				<th width="40px">代理类型</th>
				<th width="40px">返点额</th>
				<th width="40px">订单额</th>
				<th width="20px">北单</th>	
				<th width="20px">返点率</th>
				<!-- th width="10px">税率</th -->
				<th width="40px">合约</th>	
				<th width="80px">结算时间</th>
			...
			<tbody>
				...
				<tr>
					...
					<td style='font-weight:bold'><?php 
						if ($item['flag']==0) echo '<span style="color:#990099;font-weight:bold">[0]已超代派发</span>';
						else if ($item['flag']==2) echo '<span style="color:black;font-weight:bold">[2]已派发</span>';
						else if ($item['flag']==6) echo '<span style="color:#bb4219;font-weight:bold">[6]已派发超代</span>';
						else if ($item['flag']==7) echo '<span style="color:#bb4219;font-weight:bold">[7]已返一代</span>';
