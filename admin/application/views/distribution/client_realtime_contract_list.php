...
<div class="new_content">
	<div class="newgrid">
		...
		<div class="newgrid_tab fixfloat">
			<ul>
				<li class="on">
					<a href='<?php echo url::base().'distribution/client_realtime_contract/index?relationId='.$relation['id'];?>'>
		...
		<div class="newgrid_top">
			<ul class="pro_oper">
				<li>
					<a href="/distribution/client_realtime_contract/add/<?php echo $relation['id']; ?>">
			...
			<table  cellspacing="0">
				...
				<tbody>
					...
					<tr>
						<td>
							<?php if ($item['flag']==0) {?>
							<a href="<?php echo url::base().'distribution/client_realtime_contract/open/'.$item['id']; ?>">生效</a>&nbsp;
							<?php } else {?>
							<a href="<?php echo url::base().'distribution/client_realtime_contract/close/'.$item['id']; ?>">关闭</a>&nbsp;
							<?php } ?>
							<a href="<?php echo url::base().'distribution/client_realtime_contract/delete/'.$item['id']; ?>" 
