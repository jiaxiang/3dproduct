                                ...
                                <tr>
                                	...
                                	<td>
                                		<select name="agent_type">
                                			...
                                			<option <?php if ($agent['agent_type'] == 1) {echo 'selected';} ?> value="1">特殊超级代理</option>
                                			<option <?php if ($agent['agent_type'] == 2) {echo 'selected';} ?> value="2">特殊二级代理</option>
                                			<option <?php if ($agent['agent_type'] == 11) {echo 'selected';} ?> value="11">一级代理</option>
                                			<option <?php if ($agent['agent_type'] == 12) {echo 'selected';} ?> value="12">二级代理</option>
                                		</select>
                                	</td>
                                </tr>
                                <tr>
