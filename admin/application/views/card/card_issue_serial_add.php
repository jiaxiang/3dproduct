                ...
                <form id="add_form" name="add_form" method="post" onsubmit="return CheckForm()" 
                    ...
                    <div class="out_box">
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
							...
							<tr>
								...
								<td><select name="channelId" id="channelId">
									<?php
										...
										{ 
											echo "<option value=\"".$id."\">".$channel['name']."</option>";
										}
									?>
									</select>
									 &nbsp;*
							...
							<tr>
								<th>邮寄成本</th>
								<td><input type="text" name="mailCost" id="mailCost" value="0" /> &nbsp;*
									(邮寄至销售渠道的成本，仅供参考)
								</td>
							</tr>
                            </tbody>
...
function CheckForm()
{
	...
	var mailCostInput = document.getElementById("mailCost");
	if (mailCostInput.value == null || mailCostInput.value == '') {
		alert("请填入冲值卡邮寄成本");
		return false;
	}
	if (isNaN(mailCostInput.value) == true) {
		alert("邮寄成本必须是数字");
		return false;
	}
