<div class="new_content">
	<div class="newgrid">
		<div class="newgrid_tab fixfloat">
			<ul>
				<li class="on"><a href='<?php echo url::base().'card/bill/issue_bill/';?>'>发行单据列表</a></li>
				<li ><a href='<?php echo url::base().'card/bill/open_bill/';?>'>开卡单据列表</a></li>
			</ul>
		</div>
		...
		<table cellspacing="0">
			...
			<tbody>
				...
				<tr>
					<td>
					<a href="<?php echo url::base().'card/bill/issue_bill_detail/'.$item['id']; ?>" target="_blank">查看</a>&nbsp;
					</td>
