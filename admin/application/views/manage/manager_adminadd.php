            ...
            <form id="add_form" name="add_form" method="post" action="<?php echo url::base().url::current();?>">
                <div class="edit_area">
                	...
                	姓名：
                                    ...
                                    <td>
                                        <input size="50" name="name" class="text required" maxlength="50" value=""><span class="required"> *</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>选择帐户权限模板: </th>
                                    <td>
                                        <select name="role_id" class="text" change='permission_chg()'>
