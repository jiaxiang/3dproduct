                ...
                <form id="add_form" name="add_form" method="post" action="<?php echo url::base().url::current();?>">
                    <div class="out_box">
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    <th width="25%">标题<span class="required"> *</span>：</th>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="d_line">
                                        <textarea id="content" name="content" style="width:95%;" rows="20" class="text required" type="textarea"><?php echo $data['content'];?></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
