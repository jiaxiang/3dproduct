                    ...
                    <div class="out_box">
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    <th width="20%">英文名称：</th>
                                    <td><input size="60" name="name" class="text required" value="" maxlength="255"><span class="required"> *</span></td>
                                </tr>
                                <tr>
                                    <th>中文名称：</th>
                                    <td><input size="60" name="name_manage" class="text required" value="" maxlength="255"><span class="required"> *</span></td>
                                </tr>
                                <tr>
                                    <th>两位简码：</th>
                                    <td><input id="iso_code" size="10" name="iso_code" class="text required" value="" maxlength="2"><span class="required"> *</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>是否可用：</th>
