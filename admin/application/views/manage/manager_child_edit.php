                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    <th width="25%"> 用户名： </th>
                                    <td>
                                        <input size="30" name="username" class="text required" maxlength="100"  value="<?php echo $data['username'];?>"><span class="required"> *</span>
                                        [用户登录时候的用户名]
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th> 密码： </th>
                                    <td>
                                        <input size="30" id="password1" name="password1" type="password" class="text"  maxlength="50" value="">
                                        [不需要更改密码密码留空]
                                    </td>
                                </tr>
                                <tr>
                                    <th> 重复密码： </th>
                                    <td>
                                        <input size="30" id="password2" name="password2" type="password" class="text" maxlength="50">
                                    </td>
                                </tr>
                                <tr>
                                    <th> 姓名： </th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="role_id" class="text">
                                            ...
                                            <option value="<?php echo $value['id'];?>" <?php echo ($data['role_id'] == $value['id'])?'selected':'';?>><?php echo $value['name'];?></option>;
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                </tr>
