                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" size="30" name="name" class="text required" value="<?php echo $data['name'];?>" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="mail_category_id" id="mail_category_id">
                                            ...
                                            <option value="<?php echo $value['id'];?>" <?php echo $value['selected'];?>> <?php echo $value['name'];?> </option>
                                            <?php endforeach;?>
                                ...
                                <tr>
                                    ...
                                    <td class="d_line">
                                        <textarea id="content" name="content" style="width:95%;" rows="20" class="text required" type="textarea" maxth="255"><?php echo $data['content'];?></textarea>
                                    </td>
                                </tr>
