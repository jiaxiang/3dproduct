        ...
        <div class="col_main">
            ...
            <form id="add_form" name="add_form" method="post" action="<?php echo url::base() . url::current();?>">
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody>
                                <tr>
                                    <th width="25%"> 用户名： </th>
                                    <td>
                                        <input size="30" name="username" class="text required" maxlength="20"  value=""><span class="required"> *</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th> 邮箱： </th>
                                    <td>
                                        <input size="40" name="email" class="text required email" maxlength="50" value=""><span class="required"> *</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th> 密码： </th>
                                ...
                                <tr>
                                    <th> 公司名： </th>
                                    <td>
                                        <input size="50" name="name" class="text required" maxlength="80" value=""><span class="required"> *</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>选择帐户权限模板: </th>
                                ...
                                <tr>
                                    <th>联系人姓名：</th>
                                    <td>
                                        <input size="40" name="contact_name" class="text" maxlength="20" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <th>电话：</th>
                                    <td>
                                        <input size="40" name="phone" class="text" maxlength="20" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <th>传真：</th>
                                    <td>
                                        <input size="40" name="fax" class="text" maxlength="20" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <th> 国家/省/市/区： <td>
                                        ...
                                        <input size="50" name="state" id="state" class="text" maxlength="255" style="display:none;">
                                    </td>
                                </tr>
                                <tr>
                                    <th>地址：</th>
                                    <td>
                                        <input size="60" name="address" class="text" maxlength="80" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <th>移动电话：</th>
                                    <td>
                                        <input size="40" name="mobile_phone" class="text" maxlength="30" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <th>邮编：</th>
                                    <td>
                                        <input size="20" name="postcode" class="text" maxlength="20" value="">
                                    </td>
                                </tr>
                                <tr>
                                    <th>备注:</th>
                ...
                <div class="list_save">
                    ...
                    <?php echo $next_flow_btn;?>
                    <input type="hidden" name="permission" class="ui-button" value="单独分配权限" onclick='submit_form(3);'/>
