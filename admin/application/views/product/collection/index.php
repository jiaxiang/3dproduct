...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href="<?php echo url::base();?>product/collection">商品专题列表</a></li>
            </ul>
        </div>
        <div class="newgrid_top">
            <ul class="pro_oper">
                ...
                <li>
                    <a href="<?php echo url::base();?>product/collection/add" title="添加商品专题"><span class="add_pro">添加商品专题</span></a>
                </li>
            </ul>
        </div>
             ...
             <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                <thead>
                    <tr class="headings">
                        ...
                        <th width="150">操作</th>
                        <?php echo view_tool::sort('商品专题名称',2, 300);?>
                        <?php echo view_tool::sort('更新时间',4, 200);?>
                        <?php echo view_tool::sort('排序', 6, 0);?>
                    </tr>
                </thead>
                <tbody>
                  ...
                  <td> 
                  <a href="/product/collection/products?id=<?php echo $val['id'];?>">关联商品</a>
                  <a href="/product/collection/edit?id=<?php echo $val['id'];?>">编辑</a>
                  <a class="act_dodelete" href="/product/collection/delete?id=<?php echo $val['id'];?>"> 删除</a>
                  </td>
...
$('input[name=submit_order_form]').click(function(){
	var url = '<?php echo url::base();?>product/collection/set_order';
	var obj = $(this).parent();
        ...
        $("#delete_all").click(function(){
          ...
          if (ids_checked > 0) { 
          	confirm("确定删除所有被选中的项吗?",function(){
          		list_form.attr('action','<?php echo url::base();?>product/collection/delete_all');
				ajax_block.open();
          		list_form.submit();
          	});
          }else{
