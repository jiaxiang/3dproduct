...
<div id="content_frame">
    <div class="grid_c2">
        <div class="col_main">
            <form id="add_form" name="add_form" method="POST" action="<?php echo url::base();?>product/feature/put">
                        <div class="division out_box">
                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tbody>
                                    <tr>
                                        <th width=200>* 特性名称： </th>
                                    ...
                                    <tr>
                                        <th> 特性后台名： </th>
                                        <td><input id="alias" name="alias" type="input" class="text" value="<?php echo $data?$data['alias']:''?>" maxlength=255 size="50"></td>
                                    </tr>
                                    <tr>
                                        <th> 特性备注： </th>
                                        <td><input name="memo" type="input" class="text"  value="<?php echo $data?$data['memo']:''?>" maxlength=255 size="50"></td>
                                    </tr>
                                    <tr>
                                        <th> 显示类型： </th>
                                        <td>
                                            <input id="type0" name="type" type="radio" value="0" <?php if(!isset($data['type']) || $data['type']==0)echo 'checked';?>>选择项 &nbsp;&nbsp;&nbsp;&nbsp;
                                            <input id="type1" name="type" type="radio" value="1" <?php if(isset($data['type']) && $data['type']==1)echo 'checked';?>>输入项
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" width="100%">
	                		<tr>
	                            <td><input name="addoptions" id="addoptions" type="button" class="ui-button" value="新加特性值" /></td>
	                        </tr>
	                	   </table>
	                	   <table cellspacing="0" cellpadding="0" border="0" width="100%" id="options">
                               <tr>
                                  <th width="300" style="text-align:center;"><b>* 特性值名称</b></th>
                                  <th width="300" style="text-align:center;"><b>特性值后台名</b></th>
...
<div id="dialog" style="display:none;overflow:hidden;">
	<iframe frameborder="no" style="border:0px;width:100%;height:100%;" src="" scrolling="auto" id="ifr">ss</iframe>
</div>
...
$(document).ready(function(){
    ...
    */
	...
	var image;
	var show_image = "<?php echo ((isset($data['display'])?$data['display']:'') == 'image') ? '' : 'display:none';?>";
	...
	$('#addoptions').live('click', function(){
		image = '';//'<td style="'+show_image+'" class="pic" align="center" width="150"><input type="hidden" name="option_image[]"><img src="/images/attrbute_def.gif" width="30" height="30" style="vertical-align:middle"> <input num="'+number+'" class="ui-button select_pic" name="select_pic" type="button" value="选择图片" /></td>';
		$('#options').append('<tr class="option_str"><td align="center" width="300" class="d_line"><input name="option_name_'+
            number+'" type="input" class="option_name text required nameRepeat"  value="" size="50"></td><td align="center" width="300" class="d_line"><input name="option_alias_'+
            number+'" type="input" class="option_alias text aliasRepeat"  value="" size="50"></td><td align="center" width="150" class="d_line"><input name="option_order_'+
            number+'" type="input" class="option_order text required digits orderRepeat"  value="'+
            number+'" size="20"></td>'+image+'<td align="center"><a href="javascript:void(0)" class="delete_live">删除</a></td></tr>');
		//删除特性项
    ...
    $('a.delete').click(function(){
         ...
         var option_id = $(this).prev('.option_id').val();
   	     ...
   	     confirm('请确认是否删除选项值ID：'+option_id,function(){
       	   	 ajax_block.open();
             $.ajax({
