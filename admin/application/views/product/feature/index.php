...
<div class="new_content">
    <div class="newgrid">
        <div class="newgrid_tab fixfloat">
            <ul>
                <li class="on"><a href="<?php echo url::base();?>product/feature">特性列表</a></li>
            </ul>
        </div>
        <div class="newgrid_top">
            <ul class="pro_oper">
                ...
                <li>
                    <a href="<?php echo url::base();?>product/feature/add" title="添加特性"><span class="add_pro">添加特性</span></a>
                </li>
            </ul>
        </div>
             ...
             <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                ...
                <thead>
                    <tr class="headings">
                        ...
                        <th>操作</th>
                        <?php echo view_tool::sort('特性名称',2, 150);?>
                        <?php echo view_tool::sort('特性别名',-1, 150);?>
                ...
                <tbody>
                  ...
                  <td> 
                   <a href="/product/feature/edit?id=<?php echo $val['id'];?>">编辑</a>
                   <a class="act_dodelete" href="/product/feature/delete?id=<?php echo $val['id'];?>"> 删除</a>
                  </td>
...
<script type="text/javascript">
        ...
        $('input[name=submit_order_form]').click(function(){
            var url = '<?php echo url::base();?>product/feature/set_order';
            var obj = $(this).parent();
        ...
        $("#delete_all").click(function(){
            ...
            if (ids_checked > 0) { 
            	confirm("确定删除所有被选中的项吗?",function(){
            		list_form.attr('action','<?php echo url::base();?>product/feature/delete_all');
					ajax_block.open();
            		list_form.submit();
            	});
            }else{
