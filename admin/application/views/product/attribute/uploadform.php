...
?>
<form id="upload_form" name="upload_form" method="POST" action="<?php echo url::base();?>product/attribute/upload" enctype="multipart/form-data">
<div class="division">
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			<th width="20%">图片：</th>
			<td width="80%"><input type="file" name="attribute_img[]" class="attachFieldProductpic ui-button ui-state-default ui-corner-all"/></td>
		</tr>
		<tr>
			<th>描述：</th>
