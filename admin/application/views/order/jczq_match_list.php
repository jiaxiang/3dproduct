...
<script type="text/JavaScript">
        ...
        <a href="http://info.sporttery.cn/football/match_result.php" target="_blank">竞彩赛果开奖</a>&nbsp;&nbsp;格式：负|1:2|3|胜负，胜|胜其他|7+|胜胜，赛事取消填cancel
        </div>
            ...
            <table  cellspacing="0">
             <form id="list_form" name="list_form" method="post" action="<?php echo url::base() . url::current();?>">
                ...
                <tbody id="list-line">
						...
						<td><?php echo $rs['host_name'];?> VS <?php echo $rs['guest_name'];?>&nbsp;<a href="http://info.sporttery.cn/football/pool_result.php?id=<?=$rs['index_id']?>" target="_blank">赛果</a></td>            
                         <td>
