 ...
 * @version 1.0
 */
class Cache_Mem_Driver implements Cache_Interface_Driver {
	...
	{
		return $this->isConnected ? $this->mem->get($key, $this->flag) : FALSE;
	}
	...
	{
		return $this->isConnected ? $this->mem->set($key, $value, $this->flag, is_null($expire) ? $this->expire : $expire) : FALSE;
	}
