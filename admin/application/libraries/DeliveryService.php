...
class DeliveryService_Core extends DefaultService_Core {
    ...
    {
        $obj = ORM::factory('delivery')->where(array('id'=>$id))->find();
	 ...
	 * @return boolean
	 */
	public function name_is_exist($name, $delivery_id = NULL)
	{
		$query_struct = array();
	...
	{
		$delivery = ORM::factory('delivery')->where(array('name'=>$name))->find()->as_array();
		return $delivery;
	}
	...
	{
		//删除物流信息
		ORM::factory('delivery')->delete_all();
		//删除物流国家关联信息
		ORM::factory('delivery_country')->delete_all();
		return true;
	}
	 ...
	 * @return string
	 */
	public function get_delivery_name($delivery_id)
	{
