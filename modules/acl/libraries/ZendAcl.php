 ...
 */
require_once dirname(__FILE__).'/Acl/Resource/Interface.php';

/**
 * @see Zend_Acl_Role_Registry
 */
require_once dirname(__FILE__).'/Acl/Role/Registry.php';


/**
 * @see Zend_Acl_Assert_Interface
 */
require_once dirname(__FILE__).'/Acl/Assert/Interface.php';


/**
 * @see Zend_Acl_Role
 */
require_once dirname(__FILE__).'/Acl/Role.php';


/**
 * @see Zend_Acl_Resource
 */
require_once dirname(__FILE__).'/Acl/Resource.php';
...
class Zend_Acl
{
    ...
    public function addRole($role, $parents = null)
    {
        ...
        if (!$role instanceof Zend_Acl_Role_Interface) {
            require_once dirname(__FILE__).'/Acl/Exception.php';
