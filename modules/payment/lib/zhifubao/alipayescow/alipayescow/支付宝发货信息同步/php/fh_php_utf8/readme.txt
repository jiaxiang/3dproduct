...
fh_php_utf8
  ...
  │  │
  │  ├alipay_notify.php┈┈┈┈┈┈┈┈┈┈┈支付宝通知处理类文件（闲置）
  │  │
...
※注意※
需要配置的文件是：alipay_config.php、sendgoods.php

index.php仅是支付宝提供的付款入口模板文件，可选择使用。
如果商户网站根据业务需求不需要使用，请把sendgoods.php作为与商户网站网站相衔接页面。
如果需要使用index.php，那么sendgoods.php文件无需更改，只需配置好alipay_config.php文件
