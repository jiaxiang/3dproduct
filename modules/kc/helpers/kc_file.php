...
class Kc_file_Core {
     ...
     * @return string 
     */
    static function get_extension($filename, $toLower=true) 
    {
     ...
     * @return string 
     */
    static function get_mime_type($filename, $magic=null) 
    {
     ...
     * @return string
     */
    static function get_inexistant_filename($filename, $dir=null, $tpl=null) {
