...
class DeliverycnService_Core extends DefaultService_Core {
     ...
     * @return 	array  $result
     */
    public function get_delivery_price($delivery_id, $total, $weight = 0)
    {
     ...
     * @return 	array  $deliveries
     */
	public function get_final_delivery_price($delivery_id, $total, $weight = 0)
	{
		$delivery = array();
		$result = $this->get($delivery_id);
		$delivery = $this->get_delivery_price($delivery_id, $total, $weight);
		return $delivery;
	}
	...
	{
		$delivery = ORM::factory('deliverycn')->where('id',$delivery_id)->find()->as_array();
